...
public enum ZonedDateTimeEnum {
	...
	INSTANCE;
	protected final ZoneId defaultZoneId = ZoneId.of("America/Chicago");
	protected final ZoneId UTC_ZONE_ID = ZoneOffset.UTC; // Zulu or London Time +00:00
	...
	protected ZoneId getZoneId(String newZoneId) {
